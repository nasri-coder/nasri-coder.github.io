...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/b788e4a251cfc65b7d11adbb514118a1/bookingsApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then((response) => {
